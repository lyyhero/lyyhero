...
get_boom_sound = pygame.mixer.Sound('sound/get_bomb.wav')
get_boom_sound.set_volume(0.2)
        ...
        if life_num and not paused:
            ...
            if bullet_supply.active:
                ...
                if pygame.sprite.collide_mask(bullet_supply,me):
                    ...
                    pygame.time.set_timer(DOUBLE_BULLET_TIME, 8 * 1000)
